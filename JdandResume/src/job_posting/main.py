...
def run():
    inputs = {
        'path_to_job': './data/jd.md',
        'resume_path_file3': './data/resume3.pdf',
        'resume_path_file1': './data/resume1.pdf',
        'resume_path_file2': './data/resume2.pdf'
    }
...
def train():
    ...
    try:
        ...
        JobPostingCrew().crew().train(n_iterations=iterations, inputs=inputs)
